...
public class CompanyYearComparatorAbsoluteDifferenceSimilarity implements Comparator<Company,Attribute> {
    ...
    public double compare(Company record1, Company record2, Correspondence<Attribute, Matchable> schemaCorrespondences) {
        ...
        double n1 = record1.getYear();
        double n2 = record2.getYear();
