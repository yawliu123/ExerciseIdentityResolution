...
import de.uni_mannheim.informatik.dws.wdi.ExerciseIdentityResolution.Comparators_Company.CompanyAddressComparatorLevenshtein;
...
import de.uni_mannheim.informatik.dws.wdi.ExerciseIdentityResolution.Comparators_Company.CompanyNumberComparatorLevenshtein;
...
public class Linear_Gleif_Ocdata {
    ...
    public static void main(String[] args) throws Exception {
        ...
        //        "data_company/goldstandard/GS_gleif_ocdata.csv"));
        gsTest.loadFromCSVFile(new File(
                "data/GS/GS_gleif_ocdata_updated_last_phase.csv"));
        ...
        matchingRule.addComparator(new CompanyAddressComparatorLevenshtein(),0.2);
        //Blocker
       ...
       // SortedNeighbourhoodBlocker<Company, Attribute, Attribute> blocker = new SortedNeighbourhoodBlocker<>(new CompanyBlockingKeyByCompanyNumberGenerator(), 30);
        ...
        Processable<Correspondence<Company, Attribute>> correspondences = engine.runIdentityResolution(
                data_gleif, data_ocdata, null, matchingRule,
                blocker);
        // write the correspondences to the output file
        new CSVCorrespondenceFormatter().writeCSV(new File("data/output/company_gleif_ocdata_correspondences.csv"), correspondences);
        System.out.println("*\n*\tEvaluating result\n*");
        System.out.println("###########################################");
